...
for step in range(50):
    ...
    print(f"iter: {step} | loss: {loss_accum.item():.6f} | norm: {norm:.4f} | lr: {lr:.4e} | dt: {dt:.2f} ms | tokens/sec: {tokens_per_second:.2f}")

print(logits.shape) #(4, 32, 50257)

print(f'loss: {loss}') #loss: 11.119763374328613
...
# import code; code.interact(local=locals()) #debugging
#torch autocast definitely improved the speed
#using torch.compile is best
